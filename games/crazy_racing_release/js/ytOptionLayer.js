var ytOptionLayer = (function () {
	function ytOptionLayer () {
		...
		s.placeInfoList = [
			{name : "峡谷", data : "street_canyon"},
			{name : "城市", data : "street_city"},
			{name : "沙漠", data : "street_desert"},
			{name : "草原", data : "street_grass"},
			{name : "冰原", data : "street_snow"},
			{name : "大桥", data : "street_water"}
		];
