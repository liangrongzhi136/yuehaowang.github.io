var ytGameLayer = (function () {
	...
	ytGameLayer.prototype.share = function (e) {
		var s = this, ranking = e.ranking, point = e.point;
		...
		if (WinxinJSBridge) {
			WinxinJSBridge.invoke("shareTimeline", {
				img_url : "http://yuehaowang.github.io/images/demo/crazy_racing1.png",
				img_width : 400,
				img_height : 600,
				link : "http://yuehaowang.github.io/games/crazy_racing_release/",
				desc : "我在'极速飚车'飚车" + point + "m，排名：" + ranking,
				title : "快来玩'极速飚车'" 
			}, function (res) {
				alert(res.err_msg);
			});
